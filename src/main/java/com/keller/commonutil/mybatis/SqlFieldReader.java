...
import com.keller.commonutil.mybatis.annotation.*;
...
public class SqlFieldReader {
     ...
     * @return
     */
    private static <T> String getConditionSuffix(T entity, boolean isPageQuery) {
     ...
     * @return
     */
    public static <T> String getCondition(BaseQuery<T> query, T entity, boolean isPageQuery) {
        if(query == null){
            return getConditionSuffix(entity, isPageQuery);
        }
